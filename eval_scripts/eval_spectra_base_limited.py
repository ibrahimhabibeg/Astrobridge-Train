...
app = modal.App("astrobridge-evaluation-base-limited")
...
def run_evaluation(model_id: str, timestamp_dir: str, batch_size: int = 4):
    import sys
    ...
    from evals.responders.base_qwen import BaseQwenResponder
    
    device = "cuda" if torch.cuda.is_available() else "cpu"
    scheme = five_bucket_scheme()
    responder = BaseQwenResponder(model_id, device)
...
def main():
    ...
    run_evaluation.remote(model_id, timestamp_dir, batch_size=16)
